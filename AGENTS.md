...
6. **Minimum Word Count for Guides**: Every educational guide or blog post created MUST contain a minimum of **1,500 words of actual readable prose**. This is a strict requirement for SEO dominance. If a subagent is tasked with writing a guide, explicitly instruct it to exceed 1,500 words by adding historical case studies, backtesting data, deep mathematical breakdowns, and psychological factors.
