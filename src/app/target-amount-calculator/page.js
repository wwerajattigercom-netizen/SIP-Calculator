  ...
  return (
    <>
      ...
      <div className="max-w-6xl w-full mx-auto px-4 pb-16 space-y-10">
        ...
        {/* ── HOW TO USE ── */}
        <section id="how-to-use" aria-label="How to use the goal based SIP calculator" className="w-full">
           <div className="max-w-6xl mx-auto space-y-8 mt-12">
            ...
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-foreground">How to Use This Goal SIP Calculator</h2>
            </div>
