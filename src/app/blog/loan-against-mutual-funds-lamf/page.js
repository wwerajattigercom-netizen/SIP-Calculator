...
const FUNDING_STRATEGIES = [
  {
    ...
    result: 'Triggers heavy Long-Term Capital Gains (LTCG) Tax (12.5%) and completely kills the future compounding potential of those assets.',
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "A Loan Against Mutual Funds (LAMF) allows you to pledge your investment portfolio as collateral to borrow money at lower interest rates without actually selling your assets."
        }
      },
      {
        "@type": "Question",
      ...
      <article className="max-w-4xl w-full mx-auto space-y-8">
        ...
        <div className="glass-panel p-8 sm:p-12 rounded-3xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4">
              Loan Against Mutual Funds (LAMF): The "Buy, Borrow, Die" Wealth Strategy
            </h1>
        ...
        <div className="glass-panel p-6 sm:p-8 rounded-3xl mb-8">
          ...
          <div className="space-y-4 text-foreground leading-relaxed text-lg">
            ...
            <p>
              Instead, wealthy investors utilize a strategy often dubbed <em>"Buy, Borrow, Die."</em> They buy appreciating assets (like index funds), borrow money against those assets using a LAMF when they need cash, and hold the assets until they die, at which point their heirs inherit the assets with a stepped-up cost basis (eliminating the capital gains tax entirely in many tax codes).
            </p>
          </div>
        </div>
        ...
        <div className="glass-panel p-6 sm:p-8 rounded-3xl mb-8">
          ...
          <div className="space-y-4 text-foreground leading-relaxed text-lg">
            <p>
              A Loan Against Mutual Funds (LAMF) is essentially a secured overdraft facility or revolving credit line. You pledge a portion of your portfolio to the lender. In return, the lender grants you a credit limit—around 50% to 70% for equity mutual funds. 
            </p>
            <p>
              <strong>The beauty of this setup lies in three distinct advantages:</strong>
            </p>
            <ul className="list-disc pl-6 space-y-3">
              <li><strong>Retained Returns:</strong> Your pledged funds continue to stay invested in the market. If the Nifty 50 goes up by 15% that year, your pledged assets capture the entirety of that return.</li>
              <li><strong>Interest-Only Payments:</strong> Unlike a standard amortizing loan (where your EMI is heavily front-loaded with interest and principal), a LAMF usually only requires you to service the interest monthly. The principal can be repaid whenever you want.</li>
        ...
        <div className="glass-panel p-6 sm:p-8 rounded-3xl mb-8">
          ...
          <div className="space-y-4 text-foreground leading-relaxed text-lg">
            ...
            <p>
              Because your loan is secured by equity markets, the collateral's value fluctuates daily. Suppose you pledge ₹10,00,000 worth of equity and borrow the absolute maximum limit of 50%. You now have a loan. 
            </p>
            <p>
              Suddenly, a black swan event causes the stock market to crash by 20%. Your portfolio value plummets to ₹8,00,000. Now, the loan you hold exceeds the bank's maximum allowable Loan-To-Value (LTV) limit against your new portfolio value. The lender will issue a margin call, demanding that you immediately deposit cash to fix the ratio.
            </p>
            <p>
          ...
          <div className="space-y-4">
            ...
            <details className="group bg-[var(--background)] rounded-xl border border-gray-100 dark:border-white/5 open:shadow-md transition-all">
              ...
              <div className="px-6 pb-6 text-gray-600 dark:text-gray-300 leading-relaxed">
                A Loan Against Mutual Funds (LAMF) allows you to pledge your investment portfolio as collateral to borrow money at lower interest rates without actually selling your assets.
              </div>
            </details>
