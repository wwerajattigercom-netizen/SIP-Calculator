...
export default function SipVsStpPage() {
  return (
    <main className="py-8 px-4 md:px-8 max-w-4xl mx-auto space-y-8">
      <Breadcrumb items={[{ label: 'Blog', href: '/blog' }, { label: 'SIP vs STP' }]} />
      ...
      <div className="glass-panel p-6 space-y-6">
        ...
        <ol className="list-decimal pl-5 space-y-3 text-sm text-gray-600 dark:text-gray-400">
          <li>You put your ₹10 Lakhs into a Debt Fund (which earns around 6-7% safely).</li>
          <li>You set up an STP to transfer ₹1 Lakh every month from the Debt Fund to an Equity Fund.</li>
          <li>Over 10 months, your money slowly enters the stock market.</li>
          <li>You get the benefits of Rupee Cost Averaging (just like a SIP), but your un-invested money earns more interest than it would in a regular savings account!</li>
        </ol>

        <h2 className="text-xl font-bold text-foreground mt-8">4. SIP vs STP Summary</h2>
        <div className="overflow-x-auto mt-4">
          <table className="w-full text-sm text-left">
            <thead>
              <tr className="border-b border-black/10">
                <th className="py-2 pr-4 font-semibold text-foreground">Feature</th>
                <th className="py-2 pr-4 font-semibold text-[#059669]">SIP</th>
