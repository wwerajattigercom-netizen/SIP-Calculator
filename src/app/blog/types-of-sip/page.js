    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <Breadcrumb items={[{ label: 'Guides', href: '/blog' }, { label: 'Types of SIPs' }]} /><div className="mt-6 mb-10">
          <h1
            className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">The 5 Types of SIPs: Which Strategy is Best for You?
                          </h1>
          <p
            className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">Most beginners only know about the "Regular SIP" where a fixed amount is deducted every month. But modern mutual funds offer 4 advanced variations designed to beat inflation, capitalize on market crashes, and automate wealth building.
                          </p>
