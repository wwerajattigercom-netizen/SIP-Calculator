...
export const metadata = {
  ...
  description: "Stop getting confused by mutual fund returns. Learn exactly when to use CAGR (Lumpsum), XIRR (SIP), and Absolute Return to measure your true wealth growth.",
  alternates: {
    canonical: 'https://stepupcalculator.com/blog/cagr-vs-xirr-vs-absolute-return',
  }
};
...
const jsonLd = {
  ...
  description: 'Understand the difference between CAGR, XIRR, and Absolute Return. Which metric should you use for SIPs vs Lumpsum? A deep-dive guide with examples.',
    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <Breadcrumb items={[{ label: 'Guides', href: '/blog' }, { label: 'CAGR vs XIRR vs Absolute Return' }]} /><div className="mt-6 mb-10">
          <h1
          ...
          <p
            className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">When you open your mutual fund portfolio on platforms like Groww, Zerodha Coin, or Upstox, you are bombarded with different percentage numbers. Which one actually represents how much money you made? This guide demystifies financial jargon and shows you exactly how to measure your wealth.
                          </p>
          ...
          <div className="glass-panel p-6 border-l-4 border-l-[var(--color-accent)] bg-[rgba(27,58,92,0.02)]">
            ...
            <ul className="space-y-3 text-sm md:text-base text-gray-600 dark:text-gray-400 dark:text-gray-300">
              ...
              <li className="flex items-start gap-2">
                ...
                <span><strong className="text-[#C4993C]">XIRR (Extended Internal Rate of Return):</strong> The true metric for your portfolio. Use it for <strong>SIPs (Systematic Investment Plans)</strong> and irregular investments.</span>
              </li>
            </ul>
          </div>
          ...
          <div className="glass-panel p-8 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-black">
            <h2 className="text-2xl font-bold text-foreground mb-4">What Do Brokers Like Zerodha and Groww Show?</h2>
          ...
          <div className="glass-panel p-8 text-center bg-gradient-to-b from-[rgba(27,58,92,0.05)] to-transparent">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link href="/" className="inline-flex items-center justify-center gap-2 border-2 border-[var(--color-accent)]/20 text-[var(--color-accent)] hover:border-[var(--color-accent)] hover:bg-[var(--color-accent)] hover:text-white px-6 py-3 rounded-xl font-semibold transition-all">
                <Calculator className="w-5 h-5" /> Calculate SIP Future Value
              </Link>
            </div>
          </div>
