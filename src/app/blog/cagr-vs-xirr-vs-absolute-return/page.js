      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <div className="glass-panel p-5 border border-[rgba(27,58,92,0.25)]">
            <h2 className="text-[#1F2937] font-bold mb-3">The One-Line Answer</h2>
            <div className="space-y-2 text-sm">
              {[
                ...
                <div key={metric} className="flex items-start gap-2">
                  ...
                  <span className="text-gray-500"><span className={`font-bold ${color}`}>{metric}:</span> {when}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[#1F2937]">Deep Comparison</h2>
            {COMPARISON.map(({ metric, formula, useFor, bestFor, limitation, example, color, border }) => (
              <div key={metric} className={`glass-panel p-5 border ${border}`}>
                ...
                <div className="space-y-2 text-sm">
                  <div className="bg-[rgba(0,0,0,0.3)] rounded-lg px-3 py-2 font-mono text-xs text-gray-600">{formula}</div>
                  {[
                    ...
                    <div key={label} className="flex gap-2">
                      ...
                      <span className="text-gray-500 text-xs leading-relaxed">{val}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="glass-panel p-6">
            <h2 className="text-xl font-bold text-[#1F2937] mb-3">Which Metric Do Groww and Zerodha Use?</h2>
            <div className="space-y-3 text-sm text-gray-500 leading-relaxed">
              ...
              <p>
                When you look at a mutual fund's <strong className="text-[#1F2937]">historical performance</strong> (e.g., "Axis Bluechip Fund 5-year returns"),
                that number is <strong className="text-[#1B3A5C]">CAGR</strong> — assuming a single lumpsum investment at the start.
              </p>
              <div className="bg-[rgba(27,58,92,0.08)] border border-[rgba(27,58,92,0.2)] rounded-xl p-4">
                <p className="text-[#1F2937] font-semibold mb-1">⚠️ Common Mistake</p>
          ...
          <div className="glass-panel p-6">
            <h2 className="text-xl font-bold text-[#1F2937] mb-3">Why Can&apos;t You Use CAGR for SIP Returns?</h2>
            ...
            <div className="text-xs text-gray-500 bg-[rgba(0,0,0,0.04)] border border-[#E8E4DF] rounded-lg p-3">
              <p className="text-gray-600 mb-1">Rule of thumb:</p>
          ...
          <div className="glass-panel p-5 border border-amber-400/20">
            <div className="flex items-start gap-2 text-sm text-gray-500">
              ...
              <p>
                ...
                <Link href="/disclaimer" className="text-[#1B3A5C] hover:underline ml-1">Read our methodology →</Link>
              </p>
            </div>
          </div>
          ...
          <div className="glass-panel p-6 text-center bg-gradient-to-r from-[rgba(27,58,92,0.05)] to-[rgba(27,58,92,0.08)]">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link href="/cagr-calculator" className="inline-flex items-center gap-2 bg-[#1B3A5C] hover:bg-[#112740] text-white shadow-sm px-5 py-2.5 rounded-xl text-sm font-semibold transition-all">
