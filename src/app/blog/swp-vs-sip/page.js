    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <Breadcrumb items={[{ label: 'Guides', href: '/blog' }, { label: 'SWP vs SIP' }]} /><div className="mt-6 mb-10">
          <h1
          ...
          <p
            className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">SIP and SWP are two sides of the exact same coin. One builds your wealth over time, and the other pays you a monthly salary when you retire. If you want to retire comfortably, you must master both.
                          </p>
