  ...
  return (
    <main className="max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <Breadcrumb items={breadcrumbs} /><div className="mt-6 mb-10">
        <h1
          className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">How to Build a Winning Mutual Fund Portfolio in India
                    </h1>
        <p
          className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">Master the Core & Satellite strategy, avoid the trap of over-diversification, and learn exactly how to balance risk and reward for long-term wealth creation.
                    </p>
