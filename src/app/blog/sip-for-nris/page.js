    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <Breadcrumb items={[{ label: 'Guides', href: '/blog' }, { label: 'SIP for NRIs' }]} /><div className="mt-6 mb-10">
          <h1
            className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">SIP for <span className="text-[#C4993C]">NRIs</span>: The Complete 2026 Guide
                          </h1>
          <p
            className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">With the Indian stock market consistently outperforming global indices, millions of Non-Resident Indians (NRIs) want a piece of the action. Investing in Indian Mutual Funds from abroad is entirely legal, but the paperwork (KYC, FATCA, and NRE/NRO accounts) can be confusing.
                          </p>
