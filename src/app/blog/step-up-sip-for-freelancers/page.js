...
const FREELANCER_MODELS = [
  ...
  {
    type: 'The Static SIP Investor',
    icon: <Wallet className="w-6 h-6 text-amber-500" />,
    action: 'Starts a fixed SIP based on their lowest-earning month and never increases it.',
  ...
  {
    type: 'The Step-Up SIP Pro',
    icon: <ShieldCheck className="w-6 h-6 text-emerald-500" />,
    action: 'Sets a baseline SIP, but commits to a 10-15% automatic annual step-up as their average income rises.',
