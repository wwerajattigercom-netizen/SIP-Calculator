    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <Breadcrumb items={[{ label: 'Guides', href: '/blog' }, { label: 'Step-Up SIP Guide' }]} /><div className="mt-6 mb-10">
          <h1
            className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">What is a <span className="text-[var(--color-returns)]">Step-Up SIP</span>? (The 10% Rule)
                          </h1>
          <p
            className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">Most investors start a ₹10,000 SIP and forget about it for 20 years. That is a massive mistake. As your salary grows, your investments must grow too. A Step-Up SIP (or Top-Up SIP) automates this, ensuring you don't fall behind inflation.
                          </p>
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  ...
                  <tr className="bg-[rgba(5,150,105,0.05)] dark:bg-[rgba(5,150,105,0.1)]">
                    <td className="px-6 py-4 font-bold text-[var(--color-returns)]">₹10,000 SIP + 10% Annual Step-Up</td>
                    <td className="px-6 py-4 font-mono text-gray-800 dark:text-gray-200">₹68,73,000</td>
                    <td className="px-6 py-4 font-mono font-bold text-[var(--color-returns)]">₹1.97 Crores (Double!)</td>
                  </tr>
                </tbody>
              </table>
            </div>
