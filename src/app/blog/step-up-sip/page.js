...
export default function StepUpSipPage() {
  return (
    <main className="py-8 px-4 md:px-8 max-w-4xl mx-auto space-y-8">
      <Breadcrumb items={[{ label: 'Blog', href: '/blog' }, { label: 'Step-Up SIP Guide' }]} />
      ...
      <div className="glass-panel p-7 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <h1 className="text-2xl md:text-3xl font-extrabold text-foreground leading-tight mb-3">
            Step-Up SIP: The Secret to Retiring Early
          </h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
            Also known as a Top-Up SIP, this simple strategy allows you to start small and automatically increase your investment as your salary grows.
          </p>
        </div>
      </div>

      <div className="glass-panel p-6 space-y-6">
        <h2 className="text-xl font-bold text-foreground">1. What is a Step-Up SIP?</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
          When you set up a Step-Up SIP, you commit to increasing your investment amount by a certain percentage every year (e.g., 10%). 
          <br/><br/>
        ...
        <div className="bg-[rgba(5,150,105,0.05)] border border-[#059669]/20 p-5 rounded-xl">
          <h3 className="text-[#059669] font-bold flex items-center gap-2 mb-4">
            <ArrowUpCircle className="w-5 h-5" /> The ₹10,000 Challenge
          </h3>
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Let's see what happens if you invest ₹10,000 per month for 20 years (at 12% returns):
          </p>
          <ul className="list-disc pl-5 space-y-3 text-sm text-gray-600 dark:text-gray-400">
            <li><strong>Normal SIP:</strong> You end up with <strong>₹99.9 Lakhs</strong>.</li>
            <li><strong>10% Step-Up SIP:</strong> You end up with <strong>₹1.8 Crores</strong>.</li>
          </ul>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
          Absolutely. You can calculate the exact effect of a Step-Up SIP using the calculator on our homepage. We highly recommend starting with a 10% annual top-up.
        </p>
      </div>
    </main>
  );
