...
export default function TriggerSipPage() {
  return (
    <main className="py-8 px-4 md:px-8 max-w-4xl mx-auto space-y-8">
      <Breadcrumb items={[{ label: 'Blog', href: '/blog' }, { label: 'Trigger SIP Guide' }]} />
      ...
      <div className="glass-panel p-6 space-y-6">
        <h2 className="text-xl font-bold text-foreground">1. What is a Trigger SIP?</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
          Instead of investing on a fixed date (like the 5th of every month), a Trigger SIP executes an investment <em>only</em> when a certain condition is met. 
          <br/><br/>
