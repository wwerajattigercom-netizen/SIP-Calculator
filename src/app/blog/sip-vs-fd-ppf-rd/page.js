    ...
    <>
      ...
      <main className="py-6 px-2 md:px-4 flex flex-col items-center">
        <div className="max-w-6xl w-full mx-auto">
          ...
          <CalculatorTabs />
          <Breadcrumb items={[{ label: 'Blog', href: '/blog' }, { label: 'SIP vs FD vs PPF' }]} /><div className="mt-6 mb-10">
            <h1
              className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">SIP vs FD vs PPF Comparison Tool
                          </h1>
            <p
              className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">Compare the wealth generated by Mutual Fund SIPs against traditional safe investments like PPF and Bank RDs.
                          </p>
