  ...
  "@graph": [
    {
      ...
      description:
        "Free SIP calculator with step-up & inflation. Calculate monthly SIP returns, add lump sum, apply annual step-up and inflation adjustment — real-time. Works for India and globally (DCA / RSP / AIP).",
      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "A Step-Up SIP calculator lets you increase your monthly SIP by a fixed percentage every year — simulating annual salary hikes. For example, starting ₹10,000/month with 10% annual step-up means ₹11,000 in year 2, ₹12,100 in year 3, etc. It shows the massive compound effect of increasing investments over time.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Inflation reduces the purchasing power of your future corpus. ₹1 Crore in 20 years is NOT the same as ₹1 Crore today. Our inflation-adjusted SIP calculator shows what your maturity amount is worth in today's rupees, giving you a realistic financial picture for retirement and goal planning.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "At 12% annual return with no step-up: ₹10,000/month SIP for 20 years grows to approximately ₹99.9 Lakh (≈₹1 Crore). With 10% annual step-up, the same starting SIP grows to approximately ₹2.5 Crore in 20 years. Use the calculator to see your exact results.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Our calculator lets you enter an initial lump sum investment alongside your monthly SIP, and computes the combined future value with step-up and inflation adjustments — all in real time. ₹5 Lakh lump sum at 12% for 20 years becomes ~₹48 Lakh on its own.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "The ₹1 Crore Milestone Table on this calculator (the '₹1Cr Table' tab on the chart) shows exactly when your investment will cross each crore milestone — ₹1 Crore, ₹2 Crore, ₹3 Crore, etc. — and how much faster each crore arrives thanks to compounding.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Both strategies have merit. SIP offers rupee-cost averaging over market cycles while eliminating market timing risk. Lump sum benefits from maximum early compounding. This calculator lets you combine both — invest a lump sum today and continue monthly SIP with step-up.",
          },
        },
      ],
    },
...
const HOW_TO_STEPS = [
  ...
  },
  {
    ...
    desc: "If you have a one-time amount to invest alongside your monthly SIP, enter it here. It compounds at the same rate from day one.",
  },
  {
    step: "5",
        ...
        <div className="max-w-6xl w-full mx-auto">
          ...
          <div className="flex flex-col mb-6 mt-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-3xl">
              Calculate the future value of your SIP investments with advanced
            ...
            <div className="lg:col-span-6 xl:col-span-5 glass-panel p-4 lg:p-5 relative">
              ...
              <div className="mt-4 pt-4 border-t border-black/5 dark:border-white/10">
                ...
                >
                  ...
                  <span>
                    Goal Based SIP Calculator — How much SIP to reach ₹1 Crore?
                  </span>
      ...
      <div className="max-w-6xl w-full mx-auto px-4 pb-16 space-y-16 mt-12">
        ...
        >
          ...
          <div className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed space-y-4">
            <p>
              A <strong>Step-Up SIP</strong> (increasing your investment by a
            ...
            <p>
              By increasing your SIP by just <strong>10% every year</strong>,
