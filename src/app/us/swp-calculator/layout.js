export const metadata = {
  ...
  keywords: ['SWP calculator', 'systematic withdrawal plan calculator', 'SWP calculator', 'monthly income from mutual funds', 'mutual fund withdrawal calculator', 'retirement income calculator'],
  openGraph: {
