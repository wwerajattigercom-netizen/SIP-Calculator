...
export default function SWPCalculatorPage() {
  ...
  if (depletedMonthTotal) {
    ...
    longevityMessage = `Your corpus survives the full duration with ${fmtUSD(finalRemaining)} remaining`;
  }
            ...
            <div className="lg:col-span-5 glass-panel p-4 lg:p-5">
              ...
              <div className="mt-5 space-y-2 text-xs text-gray-500 dark:text-gray-400">
                {[
                  ...
                  { label: 'Withdrawal', val: `${fmtUSD(monthlyWithdrawal)}/mo` },
              ...
              <div className="glass-panel p-4 lg:p-5 flex flex-col h-full relative overflow-hidden">
                  ...
                  {chartTab === 'pie' && (
                    <>
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                        ...
                        <span className="text-lg md:text-xl font-bold text-foreground">{fmtUSD(totalWithdrawn)}</span>
                ...
                <div className="grid grid-cols-3 gap-2 relative z-10">
                  <div className="bg-black/5 dark:bg-white/5 rounded-lg p-2 flex flex-col justify-center">
                    ...
                    <div className="text-sm font-extrabold text-foreground">{fmtUSD(totalWithdrawn)}</div>
            ...
            <div className="glass-panel p-6 bg-gradient-to-r from-[rgba(27,58,92,0.1)] to-[rgba(27,58,92,0.08)]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {[
                  ...
                  { href: '/', icon: <Calculator className="w-4 h-4 text-[var(--color-accent)]" />, label: 'DCA Calculator', desc: 'Monthly DCA returns' },
