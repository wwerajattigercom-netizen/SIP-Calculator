...
export default function UsEmiCalculator() {
        ...
        <div className="max-w-6xl w-full mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-start">
            <div className="lg:col-span-5 glass-panel p-4 lg:p-5 relative">
              <InputSlider label="Loan Amount" value={loanAmount} onChange={setLoanAmount} min={10000} max={parseInt('1000000')} step={10000} prefix={currencySymbol} />
