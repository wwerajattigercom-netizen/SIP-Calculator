import USNetWorthCalculator from '@/components/USNetWorthCalculator';
import { Info } from 'lucide-react';

export const metadata = {
  title: "Net Worth Calculator | Track Your Assets & Liabilities",
  description: "Calculate your true net worth with our free online tracker. Enter your real estate, 401k, cash, mortgage, and credit card debt to see your financial standing.",
  keywords: [
    "net worth calculator", "net worth tracker", "calculate net worth US",
  ...
  alternates: {
    canonical: 'https://stepupcalculator.com/us/tools/net-worth-calculator',
  }
};

export default function USNetWorthCalculatorPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "WebApplication",
    "name": "Net Worth Calculator US",
    "description": "Calculate your true net worth by tracking your assets and liabilities.",
    "url": "https://stepupcalculator.com/us/tools/net-worth-calculator",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[var(--background)] p-5 rounded-xl border border-gray-100 dark:border-white/5 flex gap-4 shadow-sm">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xs leading-relaxed">Input the current market value of your real estate, 401k, IRA, stocks, and bank balances.</p>
            </div>
          </div>
          ...
          <div className="bg-[var(--background)] p-5 rounded-xl border border-gray-100 dark:border-white/5 flex gap-4 shadow-sm">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-xs leading-relaxed">Input the outstanding principal amounts of your mortgage, auto loan, and credit card debts.</p>
            </div>
          </div>
