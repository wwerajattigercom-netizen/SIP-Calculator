export const metadata = {
  title: 'DCA Inflation Calculator: Real Return on Your Investment',
  ...
  keywords: [
    'dca to beat inflation', 'real return dca', 'inflation adjusted dca calculator', 'dca after inflation'
  ],
  authors: [{ name: 'Rajat' }],
  robots: 'index, follow',
  openGraph: {
