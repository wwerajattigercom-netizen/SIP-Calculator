  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mt-16 bg-white rounded-3xl p-8 shadow-sm border border-gray-100 max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold text-[#1F2937] mb-6">Why You Should Compare Savings vs DCA</h2>
        ...
        <div className="space-y-6 text-gray-600 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-[#1F2937] mt-8 mb-4">What is Dollar Cost Averaging (DCA)?</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-[#1F2937] mt-8 mb-4">The Opportunity Cost of Cash</h3>
          <p>
