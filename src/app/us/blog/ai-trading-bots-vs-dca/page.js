  ...
  return (
    <div className="max-w-6xl w-full mx-auto px-4 py-8">
      ...
      <div className="glass-panel p-6 sm:p-8 rounded-3xl mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
          <strong>1. Software Subscriptions and Signal Fees:</strong> Quality algorithmic software isn&apos;t free. Investors often pay anywhere from $50 to $200 per month just to license the bot or receive its trading signals. If you are starting with a portfolio of $5,000, a $100 monthly fee represents an immediate 2% monthly drawdown on your capital. The bot has to generate a 2% return every single month just to break even, a nearly impossible feat over a prolonged period.
        </p>
        <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
        ...
        <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
          <strong>3. Bid-Ask Spread Erosion:</strong> High-frequency trading relies on exploiting small price movements multiple times a day. However, every time you buy and sell, you cross the bid-ask spread. In highly liquid stocks, this spread might be a few cents, but it still adds up. If a bot makes 10 trades a day, paying a 0.05% spread on each, it loses 0.5% of its capital daily just to market makers. Over a year with 250 trading days, spread erosion alone can wipe out a massive portion of the portfolio.
        </p>
        <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
