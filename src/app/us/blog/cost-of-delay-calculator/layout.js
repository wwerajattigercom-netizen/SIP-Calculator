export const metadata = {
  ...
  keywords: ['cost of delay calculator', 'DCA delay calculator', 'late start DCA impact', 'cost of waiting to invest', 'DCA delay cost India'],
  openGraph: {
  ...
  alternates: { canonical: 'https://stepupcalculator.com/us/cost-of-delay-calculator',
    languages: {
