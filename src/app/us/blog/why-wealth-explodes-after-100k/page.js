    ...
    <main className="min-h-screen pt-24 pb-16">
      <div className="max-w-4xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="glass-panel p-6 sm:p-10 md:p-12 mt-6 rounded-3xl">
          <header className="mb-12 text-center border-b border-black/5 dark:border-white/10 pb-10">
          ...
          <article className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <div className="bg-background border border-black/5 dark:border-white/10 p-6 sm:p-8 rounded-2xl mb-12 border-l-4 border-l-[var(--color-accent)] shadow-sm">
            ...
            <div className="grid gap-6 mb-12">
              {STAGES.map((stage, idx) => (
                <div key={idx} className="bg-background border border-black/5 dark:border-white/10 p-6 rounded-2xl flex flex-col md:flex-row items-start md:items-center gap-6 shadow-sm">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-2">
                      <h3 className="text-xl font-bold text-foreground m-0">{stage.target}</h3>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-medium mb-1 m-0">Driver: {stage.driver}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-500 m-0">{stage.effort}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <ul className="space-y-6 mb-12 m-0 p-0 list-none">
            ...
            <div className="bg-background border border-[var(--color-accent)]/20 rounded-2xl p-8 md:p-10 text-center mt-16 shadow-sm">
