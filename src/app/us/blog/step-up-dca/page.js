    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <Breadcrumb items={[{ label: 'Guides', href: '/us/blog' }, { label: 'Step-Up DCA Guide' }]} /><div className="mt-6 mb-10">
          <h1
            className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">What is a <span className="text-[var(--color-returns)]">Step-Up DCA</span>? (The 10% Rule)
                          </h1>
          <p
            className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">Most investors start a $1,000 DCA and forget about it for 20 years. That is a massive mistake. As your salary grows, your investments must grow too. A Step-Up DCA (or Top-Up DCA) automates this, ensuring you don't fall behind inflation.
                          </p>
          ...
          <div className="glass-panel p-8 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-black border border-[rgba(27,58,92,0.1)]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  <tr className="bg-[var(--panel-bg)] dark:bg-black/20 border-b dark:border-gray-800">
                  ...
                  <tr className="bg-[rgba(5,150,105,0.05)] dark:bg-[rgba(5,150,105,0.1)]">
                    <td className="px-6 py-4 font-bold text-[var(--color-returns)]">$1,000 DCA + 10% Annual Step-Up</td>
                    <td className="px-6 py-4 font-mono text-gray-800 dark:text-gray-200">$687,300</td>
                    <td className="px-6 py-4 font-mono font-bold text-[var(--color-returns)]">$1.97 Million (Double!)</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="glass-panel p-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-300 text-sm leading-relaxed">Yes, in almost all circumstances. A regular DCA loses its real value over time due to inflation. A Step-Up DCA ensures your contributions grow in tandem with inflation and your rising income, leading to significantly higher final wealth.</p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-1">Can I cap the Step-Up amount?</h3>
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-300 text-sm leading-relaxed">Absolutely. Most brokerages allow you to set a maximum limit. For example, you can set your DCA to increase by 10% annually until the monthly deduction hits $2,500, after which it will stay flat at $2,500.</p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-1">What if I face a pay cut or lose my job?</h3>
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-300 text-sm leading-relaxed">You can always pause, modify, or cancel a Step-Up DCA mandate at any time without penalties. It is entirely flexible. If you hit a rough patch, simply log into your brokerage and lower the amount.</p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-1">Does this work for 401(k) accounts?</h3>
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-300 text-sm leading-relaxed">Yes! In fact, many modern 401(k) providers offer an "Auto-Increase" feature that does exactly this—automatically boosting your contribution rate by 1% each year until it hits a target percentage.</p>
              </div>
            </div>
          </div>
