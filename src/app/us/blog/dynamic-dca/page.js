...
export default function DynamicSipPage() {
  return (
    <main className="py-8 px-4 md:px-8 max-w-4xl mx-auto space-y-8">
      <Breadcrumb items={[{ label: 'Blog', href: '/blog' }, { label: 'Dynamic DCA' }]} />
      ...
      <div className="glass-panel p-6 space-y-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
          A Dynamic DCA looks at market metrics (like the P/E ratio of the S&P 500). 
          If the P/E ratio is high (the market is expensive), the Dynamic DCA automatically reduces your investment amount. 
