...
export default function FlexiSipPage() {
  return (
    <main className="py-8 px-4 md:px-8 max-w-4xl mx-auto space-y-8">
      <Breadcrumb items={[{ label: 'Blog', href: '/blog' }, { label: 'Flexi DCA Guide' }]} />
      ...
      <div className="glass-panel p-6 space-y-6">
        <h2 className="text-xl font-bold text-foreground">1. What is a Flexi DCA?</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
          A Flexible DCA (or Flexi DCA) allows you to change your investment amount every month. You define a <strong>minimum</strong> amount and a <strong>maximum</strong> amount, and you can choose how much to invest depending on your cash flow or market conditions.
        </p>
        ...
        <h2 className="text-xl font-bold text-foreground mt-8">2. Flexi DCA for Market Timing</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-3 text-sm text-gray-600 dark:text-gray-400 mt-4">
          <li><strong>When markets are high:</strong> You invest your minimum amount (e.g., $500) because stocks are expensive.</li>
          <li><strong>When markets crash:</strong> You invest your maximum amount (e.g., $2,500) to buy cheap units at a massive discount.</li>
        </ul>
