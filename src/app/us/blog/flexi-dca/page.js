    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <Breadcrumb items={[{ label: 'Guides', href: '/us/blog' }, { label: 'Flexi DCA Guide' }]} /><div className="mt-6 mb-10">
          <h1
            className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">What is a <span className="text-[var(--color-accent)]">Flexi DCA?</span>(And Who Should Use It)
                          </h1>
          <p
            className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">Regular DCAs force you to pay the exact same amount every single month, no matter what. But what if you are a freelancer with variable income? Or what if you want to invest *more* when the stock market crashes? Enter the Flexi DCA.
                          </p>
