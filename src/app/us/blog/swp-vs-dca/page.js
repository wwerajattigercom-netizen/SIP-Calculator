    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-3xl w-full mx-auto space-y-8">
          ...
          <Breadcrumb items={[{ label: 'Guides', href: '/us/blog' }, { label: 'SWP vs DCA' }]} /><div className="mt-6 mb-10">
          <h1
            className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">
            <span className="text-[var(--color-returns)]">SWP</span>vs <span className="text-[var(--color-accent)]">DCA</span>: The Two Halves of Your Financial Life
                          </h1>
          <p
            className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">DCA and SWP are two sides of the exact same coin. One builds your wealth over time, and the other pays you a monthly salary when you retire. If you want to retire comfortably, you must master both.
                          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-0 overflow-hidden rounded-2xl border border-[rgba(27,58,92,0.15)]">
              ...
              <div className="p-6 md:p-8 border-b border-[var(--panel-border)] dark:border-gray-800 relative bg-[rgba(27,58,92,0.02)]">
                ...
                <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-4 relative z-10">Tool Used: DCA</p>
          ...
          <div className="glass-panel p-8 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[rgba(153,27,27,0.05)] border border-[rgba(153,27,27,0.2)] p-5 rounded-xl">
                <h3 className="font-bold text-[var(--color-loss)] mb-3">The CD Tax Trap</h3>
          ...
          <div className="glass-panel p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-300">
              ...
              <div>
                <h3 className="font-bold text-[var(--color-loss)] flex items-center gap-2 mb-2">
                  The Cons
                </h3>
                <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-300">
          ...
          <div className="glass-panel p-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-300 text-sm leading-relaxed">While mechanically possible across different funds, it is highly inefficient and mathematically counterproductive to simultaneously put money into and take money out of the same portfolio.</p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-1">What is a safe withdrawal rate for my SWP?</h3>
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-300 text-sm leading-relaxed">The widely accepted standard in the US is the 4% Rule. This suggests you can safely withdraw 4% of your starting retirement portfolio value annually, adjusted for inflation, for 30 years without running out of money.</p>
              </div>
              <div>
                <h3 className="font-bold text-foreground mb-1">Should my SWP be from an equity or debt fund?</h3>
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-300 text-sm leading-relaxed">To minimize the Sequence of Returns Risk, it is highly recommended to run your SWP from a low-volatility bond or debt fund, while keeping the rest of your corpus growing in equity index funds.</p>
              </div>
            </div>
          </div>
