...
export default function SwpVsSipPage() {
  return (
    <main className="py-8 px-4 md:px-8 max-w-4xl mx-auto space-y-8">
      <Breadcrumb items={[{ label: 'Blog', href: '/blog' }, { label: 'SWP vs DCA' }]} />
      ...
      <div className="glass-panel p-6 space-y-6">
        ...
        <ul className="list-disc pl-5 space-y-3 text-sm text-gray-600 dark:text-gray-400 mt-4">
          <li><strong>Phase 1 (Age 30 to 55):</strong> Rahul starts a <strong>DCA</strong> of $1,000 per month. Over 25 years at 12% CAGR, he builds a massive corpus of $1.9 Million.</li>
          <li><strong>Phase 2 (Age 55+):</strong> Rahul retires. He stops his DCA. He now starts an <strong>SWP</strong> on that $1.9 Million corpus, withdrawing $5,000 every month to pay for his living expenses.</li>
        </ul>

        <h2 className="text-xl font-bold text-foreground mt-8">3. Taxation: Why SWP Beats Savings Accounts</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
          ...
          <br/><br/>
          However, in an SWP from an equity mutual fund, you only pay Long Term Capital Gains (LTCG) tax on the <em>profit portion</em> of the withdrawal, and you get a ₹1.25 Lakh exemption every year. This makes SWP highly tax-efficient for retirees globally.
        </p>
      </div>
      ...
      <div className="glass-panel p-6 text-center bg-gradient-to-r from-[rgba(27,58,92,0.1)] to-[rgba(27,58,92,0.08)]">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link href="/us/dca-calculator" className="inline-flex items-center gap-2 bg-[var(--color-accent)] hover:bg-[#112740] text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-all">
