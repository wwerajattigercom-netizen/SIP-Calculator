    ...
    <div className="max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
      ...
      <header className="mb-10 mt-6">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">
          The 50% Rule: Investing Your Annual Raises in Step-Up DCA
        </h1>
        <p className="text-lg text-gray-600 dark:text-gray-300">
          Discover how applying the 50% rule to your annual performance reviews can help you avoid lifestyle creep, aggressively grow your wealth, and reach financial freedom years ahead of schedule.
        </p>
      </header>
