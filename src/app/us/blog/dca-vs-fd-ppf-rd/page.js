    ...
    <>
      ...
      <main className="py-6 px-2 md:px-4 flex flex-col items-center">
        <div className="max-w-6xl w-full mx-auto">
          ...
          <CalculatorTabs />
          <Breadcrumb items={[{ label: 'Blog', href: '/blog' }, { label: 'DCA vs CD vs 401(k)' }]} /><div className="mt-6 mb-10">
            <h1
              className="text-3xl md:text-5xl font-extrabold text-foreground leading-tight mb-4 mt-6">DCA vs CD vs 401(k) Comparison Tool
                          </h1>
            <p
              className="text-gray-600 dark:text-gray-400 text-base md:text-lg leading-relaxed mb-6">Compare the wealth generated by Equity Mutual Fund Dollar Cost Averaging (DCA) against traditional safe investments like 401(k) and Bank High-Yield Savings Accounts (HYSAs).
                          </p>
