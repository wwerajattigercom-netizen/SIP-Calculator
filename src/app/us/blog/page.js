...
const ARTICLES = [{
  ...
  {
    href: '/us/blog/pay-off-mortgage-vs-investing',
    tag: 'Real Estate',
    tagColor: 'text-[#1B3A5C] bg-[#1B3A5C]/10 border-[#1B3A5C]/20',
    title: 'Paying Off Mortgage Early vs Investing (DCA) in the S&P 500',
    excerpt: 'Should you use extra cash to clear your mortgage or invest it in the market? We break down the math and tax implications.',
    readTime: '8 min read',
    cta: 'Read Guide',
  ...
  {
    href: '/us/blog/auto-loan-vs-dca',
    tag: 'Opportunity Cost',
    tagColor: 'text-[#991B1B] bg-[#991B1B]/10 border-[#991B1B]/20',
    title: 'Auto Loan vs DCA: How Your Car is Destroying Your Retirement',
    excerpt: 'See what happens to your retirement corpus when you invest $500/month instead of paying it toward a depreciating asset.',
    readTime: '9 min read',
    cta: 'Read Guide',
    icon: <AlertTriangle className="w-5 h-5 text-[#991B1B]" />,
    highlight: 'Trending',
  ...
  {
    href: '/us/blog/dca-at-all-time-highs',
    tag: 'Market Timing',
    tagColor: 'text-[#C4993C] bg-[#C4993C]/10 border-[#C4993C]/20',
    title: 'DCA at S&P 500 All-Time Highs vs Waiting for a Market Correction',
    excerpt: 'Historical data reveals why trying to time the market usually results in lost returns, and why DCA thrives at market peaks.',
    readTime: '12 min read',
    cta: 'Read Guide',
    icon: <TrendingUp className="w-5 h-5 text-[#C4993C]" />,
  },
  {
    href: '/us/blog/step-up-dca-for-late-starters',
    tag: 'Retirement Strategy',
    tagColor: 'text-[#059669] bg-[#059669]/10 border-[#059669]/20',
    title: 'Step-Up DCA vs Regular DCA: Catching Up on Retirement at 35+',
    excerpt: 'Starting late? Discover how increasing your DCA by just 10% every year can mathematically bridge the 10-year gap you missed.',
    readTime: '9 min read',
    cta: 'Read Guide',
  ...
  {
    href: '/us/blog/gold-vs-sp500-dca',
    tag: 'Inflation Hedges',
    tagColor: 'text-[#C4993C] bg-[#C4993C]/10 border-[#C4993C]/20',
    title: 'Physical Gold vs S&P 500 DCA: The Ultimate Inflation Hedge',
    excerpt: 'A side-by-side comparison of the traditional safe haven against equity over a 15-year horizon, factoring in post-tax returns.',
    readTime: '8 min read',
    cta: 'Read Guide',
