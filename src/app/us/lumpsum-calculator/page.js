      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'A lumpsum investment is a one-time, single investment made at once — as opposed to a DCA (Dollar Cost Averaging) where you invest a fixed amount monthly. Lumpsum investing is common for windfalls like bonuses, inheritances, or proceeds from selling an asset.',
          },
        },
        {
          '@type': 'Question',
...
const FAQS = [
  {
    ...
    a: 'A lumpsum investment is a single one-time investment — unlike DCA where you invest monthly. It\'s ideal for windfalls like bonuses, property sale proceeds, or inheritances. 100% of the capital starts compounding immediately from day one.',
  },
  {
...
export default function LumpsumCalculatorPage() {
  ...
  // ── Pie chart (same colours as DCA tab) ──
  const pieData = {
    ...
    <>
      ...
      <main className="py-6 px-2 md:px-4 flex flex-col items-center">
        <div className="max-w-6xl w-full mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-start">
            ...
            <div className="lg:col-span-7">
              <div className="glass-panel p-4 lg:p-5 flex flex-col h-full relative overflow-hidden">
                  ...
                  {chartTab === 'pie' && (
                    <>
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                        ...
                        <span className="text-lg md:text-xl font-bold text-foreground">{fmtUSD(futureValue)}</span>
                ...
                {/* Breakdown cards — same as DCA tab */}
                <div className="grid grid-cols-3 gap-2 relative z-10">
                  <div className="bg-black/5 dark:bg-white/5 rounded-lg p-2 flex flex-col justify-center">
                    ...
                    <div className="text-sm font-extrabold text-foreground">{fmtUSD(futureValue)}</div>
          ...
          <div className="text-sm font-extrabold text-[var(--color-returns)]">+{fmtUSD(gain)}</div>
