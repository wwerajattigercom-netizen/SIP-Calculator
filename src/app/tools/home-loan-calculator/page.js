  ...
  '@graph': [
    {
      ...
      description: 'Calculate your home loan EMI, total interest payable, and view your complete year-by-year amortization schedule.',
      url: 'https://stepupcalculator.com/tools/home-loan-calculator',
    ...
    <>
      ...
      <main className="py-6 px-2 md:px-4 flex flex-col items-center">
        <div className="max-w-6xl w-full mx-auto">
          <CalculatorTabs />
          <Breadcrumb items={[{ label: 'Home Loan EMI Calculator' }]} />
          ...
          <div className="flex flex-col mb-6 mt-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-3xl">
              Calculate your home loan EMI, total interest payable, and view your complete year-by-year amortization schedule.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-start">
            <div className="lg:col-span-5 glass-panel p-4 lg:p-5 relative">
              <InputSlider label="Loan Amount" value={loanAmount} onChange={setLoanAmount} min={10000} max={parseInt('100000000')} step={10000} prefix={currencySymbol} />
