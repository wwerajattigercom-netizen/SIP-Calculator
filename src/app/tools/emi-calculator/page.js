  ...
  '@graph': [
    {
      '@type': 'WebApplication',
      name: 'EMI Calculator',
      description: 'Calculate your Equated Monthly Installment (EMI) for any loan with an interactive amortization schedule.',
      url: 'https://stepupcalculator.com/tools/emi-calculator',
        ...
        <div className="max-w-6xl w-full mx-auto">
          ...
          <div className="flex flex-col mb-6 mt-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-3xl">
              Calculate your Equated Monthly Installment (EMI) for any loan with an interactive amortization schedule.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-start">
            <div className="lg:col-span-5 glass-panel p-4 lg:p-5 relative">
              <InputSlider label="Loan Amount" value={loanAmount} onChange={setLoanAmount} min={10000} max={parseInt('50000000')} step={10000} prefix={currencySymbol} />
