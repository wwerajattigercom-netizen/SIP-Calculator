  ...
  '@graph': [
    {
      ...
      description: 'Calculate your car loan EMI, total interest payable, and view your complete year-by-year amortization schedule.',
      url: 'https://stepupcalculator.com/tools/car-loan-calculator',
        ...
        <div className="max-w-6xl w-full mx-auto">
          ...
          <div className="flex flex-col mb-6 mt-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-3xl">
              Calculate your car loan EMI, total interest payable, and view your complete year-by-year amortization schedule.
            </p>
          </div>
