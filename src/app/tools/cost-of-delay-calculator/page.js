...
const jsonLd = {
  ...
  '@graph': [
    {
      '@type': 'WebApplication',
      name: 'Cost of Delay Calculator — SIP Investment Delay Impact',
      description: 'Calculate the devastating impact of delaying your SIP investment. See how much wealth you lose and what it takes to catch up.',
      url: 'https://stepupcalculator.com/cost-of-delay-calculator',
      applicationCategory: 'FinanceApplication',
      operatingSystem: 'Any',
      offers: { '@type': 'Offer', price: '0', priceCurrency: 'INR' },
      featureList: [
        'SIP cost of delay calculation',
        'Compare Start Now vs Start Late scenarios',
        'Calculate extra SIP needed to catch up',
    ...
    },
    {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'What is the Cost of Delay in SIP?',
          acceptedAnswer: {
            '@type': 'Answer',
        ...
        {
          '@type': 'Question',
          name: 'How does delaying SIP affect my wealth?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'When you delay, you miss out on the crucial later years of compounding where your money grows the most. For example, delaying a ₹10,000/month SIP by just 5 years on a 20-year horizon can reduce your final corpus by more than 50%.',
          },
        },
        {
          '@type': 'Question',
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'To make up for lost time, you must significantly increase your monthly SIP amount. Often, a 5-year delay requires you to invest more than double the original monthly amount to reach the same financial goal.',
          },
        },
        {
          '@type': 'Question',
...
const FAQS = [
  {
    q: 'What is the Cost of Delay in SIP?',
  ...
  {
    q: 'How does delaying SIP affect my wealth?',
    a: 'When you delay, you miss out on the crucial later years of compounding where your money grows the most. For example, delaying a ₹10,000/month SIP by just 5 years on a 20-year horizon can reduce your final corpus by more than 50%.',
  },
  {
    q: 'How can I recover the cost of delay?',
    a: 'To make up for lost time, you must significantly increase your monthly SIP amount. Often, a 5-year delay requires you to invest more than double the original monthly amount to reach the same financial goal in the compressed timeframe.',
  },
  {
...
export default function CostOfDelayCalculatorPage() {
  ...
  const { fvStartNow, fvStartLate, costOfDelay, extraSIP, wealthLostPct, yearlyData } = useMemo(() => {
    ...
    // To catch up, what SIP is needed for n2 periods to reach fv1?
    let requiredSIP = 0;
    if (n2 > 0) {
      if (r === 0) {
        requiredSIP = fv1 / n2;
    ...
    <>
      ...
      <main className="py-6 px-2 md:px-4 flex flex-col items-center">
        <div className="max-w-6xl w-full mx-auto">
          <CalculatorTabs />
          <Breadcrumb items={[{ label: 'Tools', href: '/tools' }, { label: 'Cost of Delay Calculator' }]} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-start">
            ...
            <div className="lg:col-span-5 glass-panel p-5 lg:p-6">
              <InputSlider label="Monthly SIP Amount" value={monthlySIP} onChange={setMonthlySIP} min={500} max={500000} step={500} prefix="₹" />
