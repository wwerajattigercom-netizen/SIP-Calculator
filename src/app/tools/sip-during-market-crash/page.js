    ...
    <>
      ...
      <main className="py-8 px-2 md:px-4 flex flex-col items-center">
        <article className="max-w-6xl w-full mx-auto space-y-8">
          ...
          <CalculatorTabs />
          <Breadcrumb items={[{ label: 'Tools', href: '/tools' }, { label: 'SIP During Market Crash' }]} />
              ...
              <table className="w-full text-sm text-left">
                <thead>
                  <tr className="border-b border-black/5">
                    ...
                    <th className="py-2 pr-4 text-[var(--color-loss)] font-semibold">Nifty Drop</th>
          ...
          <div className="glass-panel p-6 space-y-6">
            <div>
              <h2 className="text-xl font-bold text-foreground mb-3 flex items-center gap-2">
                <AlertTriangle className="w-5 h-5 text-[var(--color-loss)]" /> Why Stopping SIP During a Crash is the Worst Mistake
              </h2>
