      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="glass-panel p-6 bg-[var(--background)] rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="bg-[var(--background)] p-4 rounded-xl border border-[var(--panel-border)]">
                ...
                <p className="text-xs text-[#6B7280] mt-2">Initial Monthly EMI: {formatCurrency(results.monthlyEmi)}</p>
              </div>
              <div className="bg-[var(--background)] p-4 rounded-xl border border-[#C4993C]/30">
                ...
                <p className="text-xs text-[#6B7280] mt-2">Initial SIP: {formatCurrency(results.monthlyEmi + ((propertyValue * (propertyTaxPercent/100))/12) + ((propertyValue * (maintenancePercent/100))/12) - monthlyRent)}</p>
              </div>
            </div>
          ...
          <div className="glass-panel p-6 bg-[var(--background)] rounded-2xl">
            ...
            <p className="text-sm text-[#6B7280] mb-6">A breakdown of the unrecoverable costs (sunk costs) over {loanTenure} years.</p>
