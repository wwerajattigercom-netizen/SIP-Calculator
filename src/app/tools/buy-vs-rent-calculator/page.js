    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-[#6B7280] max-w-2xl mx-auto">
          Compare the financial impact of buying a home on EMI versus renting and investing the difference in an Equity SIP.
        </p>
      </div>
          ...
          <div className="glass-panel p-6 bg-[var(--background)] rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              ...
              <div className="bg-[var(--background)] p-4 rounded-xl border border-[#C4993C]/30">
                ...
                <p className="text-xs text-[#6B7280] mt-2">Initial SIP: {formatCurrency(emi - monthlyRent)}</p>
              </div>
            </div>
