        ...
        {results.inflationAdjustedAmount < results.actualAmount && (
          <div className="col-span-3 mt-1 bg-[rgba(196,153,60,0.2)] border border-[rgba(196,153,60,0.5)] rounded-lg px-3 py-2 flex items-center justify-between">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[#1F2937] text-[10px] font-semibold tracking-wide">In Today's Value (Inflation Adjusted)</span>
            </div>
            <div className="text-right">
              <div className="text-sm font-extrabold text-[#1F2937]">
                {formatCurrency(results.inflationAdjustedAmount)}
              </div>
              <div className="text-[9px] text-[#1F2937] opacity-70 tracking-wide">
